                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="panel">
                                    ...
                                    <form id='basicForm' name='basicForm' enctype="multipart/form-data" action='{{ url("descumprimento/incluiravaliacaocoordenacao")}}' method="post" class='form-horizontal'>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <select class="select2" id="bit_coordenacao" name="bit_coordenacao" style="width: 100%" data-placeholder="Informe sua decisão"  title="Campo avaliação obrigatório!! Favor preencher!" required>
                                                    <option disabled></option>
                                                    <option value="1">Favorável prosseguir com o descumprimento</option>
                                                    <option value="0">Solicitar retificação da minuta</option>
                                                    <option value="2">Cancelar por determinação da Coordenação</option>
                                                </select>
                                            </div>
                                        </div>
                                        <!-- form-group -->
                                        ...
                                        <div class="form-group" id="campo_texto_avaliacao_acat">
                                            ...
                                            <div class="panel-body col-sm-9" style="margin-left: -10px">
                                                <textarea style="width: 90.7%;" name="ds_avacoordenacao"
                                                          id="ds_acatado" placeholder="Informe sua avaliação...Obs: Campo opcional em casos de acatamento!"
                                                          class="wtext" rows="9">
...
<script>
                                                    $(document).ready(function () {
                                                        ...
                                                        $("#bit_coordenacao").change(function () {

                                                            if ($("#bit_coordenacao").val() == 0 || $("#bit_coordenacao").val() == 2)
                                                            {

                                    ...
                                    <form id='basicForm' name='basicForm' enctype="multipart/form-data" action='#' method="post" class='form-horizontal'>
                                        ...
                                        <div class="panel-body nopaddingtop">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <select class="select2" id="id_impactada"
                                                            name="id_coordenacao" style="width: 100%"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" name="id_motivo" id="ds_titulo" value="Não conforme de acordo com o prazo" class="form-control" disabled />
                                                </div>
                                            </div>
                                            ...
                                            <br>
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label"><b>Avaliação</b><span class="text-danger">*</span></label>
                                                <div class="col-sm-8">
                                                    <select disabled class="select2" id="bit_acatamento" name="bit_aceito_caixa" style="width: 100%" data-placeholder="Informe sua decisão"  title="Campo Justificativa Obrigatório!! Favor preencher!" required>
                                                        <option  disabled></option>
                                                        <option value="1" <?php if($Slm->bit_aceito_caixa == 1) echo 'selected';?>>Justificativa acatada</option>
                                                        <option value="0" <?php if($Slm->bit_aceito_caixa == 0) echo 'selected';?>>Justificativa não acatada</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <!-- form-group -->
                                            <div class="form-group" id="campo_texto_avaliacao">
                                                <label class="col-sm-3 control-label"><b>Descrição da justificativa</b></label>
                                                <div class="panel-body col-sm-9" style="margin-left: -10px">
                                                    <textarea disabled style="width: 90.7%;" name="ds_caixa" id="ds_avaliacao" placeholder="Informe sua justificativa" class="wtext" rows="12">{{$Slm->ds_caixa}}</textarea>
                                                </div>
                                            </div>

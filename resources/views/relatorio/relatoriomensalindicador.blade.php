                        ...
                        <div class="panel">
                            ...
                            <div class="panel-heading">
                                ...
                                <div class="panel-body">
                                    ...
                                    <form  id="relatoriomensal" name="" enctype="multipart/form-data" action='{{ url("relatorio/relatoriomensalporindicador")}}' method="post" class="">
                                    ...
                                    if ($All != 'vazio') {
                                        ...
                                        ?>
                                    <center><h1 style="font-size: 2em; margin-top:40px; margin-bottom: 40px; color: #1c60ab;">Relatorio de <?= $titulo_mes; ?>: <?= $empresa;?> - <?= $titulo_contrato['nu_contrato'] ?> </h1></center>
                                        <?php
                                                        ...
                                                        @foreach ($Notificacoes as $n)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    @if($n->bit_aceito == 55)
                                                                    <span style="color: red; font-weight: bold;">Justificativa Não acatada - Tempo de resposta esgotado!</span>
                                                                    @endif

                                                                    @if($n->bit_aceito == 44)
                                                                    <span style="color: green; font-weight: bold;">Justificativa Acatada - Tempo de resposta esgotado!</span>
                                                                    @endif

                                                                    @if($n->bit_aceito == 5)
                                                                    <span style="color: red; font-weight: bold;">Justificativa não acatada</span>
                                                                    @endif

                                                                    @if($n->bit_aceito == 4)
                                                                    <span style="color: green; font-weight: bold;">Justificativa acatada</span>
                                                                    @endif

...
<script src="{{ asset("theme/lib/datatables-plugins/integration/bootstrap/3/dataTables.bootstrap.js") }}"></script>
<script src="{{ asset("theme/lib/jquery-toggles/toggles.js") }}"></script>
<script src="{{ asset("theme/lib/jquery-autosize/autosize.js") }}"></script>
<script src="{{ asset("theme/lib/select2/select2.js") }}"></script>
<script src="{{ asset("theme/lib/jquery-toggles/toggles.js") }}"></script>

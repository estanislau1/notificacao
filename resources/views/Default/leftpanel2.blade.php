    ...
    <div class="leftpanelinner">
        ...
        <div class="media leftpanel-profile">
             <div class="media-body">
               ...
               <li> <a href="{{ url("notificacao")}}">
                    <button class="btn btn-blue btn-quirk" style="width:100%">HOME - Nível de serviço</button>
                </a></li>
               <li> <a style="margin-top:15px; display:block;" href="{{ url("descumprimento")}}">
                    <button class="btn btn-cor btn-quirk" style="width:100%">HOME - Contratual</button>
                </a></li>

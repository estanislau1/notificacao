                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="panel">
                                    ...
                                    <form id='basicForm' name='basicForm' enctype="multipart/form-data" action='{{ url("slm/incluirjustificativa")}}' method="post" class='form-horizontal'>
                                        ...
                                        <div class="panel-body nopaddingtop">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <select class="select2" id="id_impactada"
                                                            name="id_coordenacao" style="width: 100%"
                                                            data-placeholder="Selecione uma coordenação..."
                                                            title="Você precisa selecionar a coordenação impactada">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <select class="select2" id="bit_acatamento" name="bit_aceito_terceiro" style="width: 100%" data-placeholder="Informe sua decisão"  title="Campo Justificativa Obrigatório!! Favor preencher!">
                                                        <option value=""></option>
                                                        <option value="1">Concordo</option>
                                                        <option value="0">Não Concordo</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <!-- form-group -->
                                            ...
                                            <div class="form-group" id="campo_texto_avaliacao">
                                                ...
                                                <div class="panel-body col-sm-9" style="margin-left: -10px">
                                                    <textarea style="width: 90.7%;" name="ds_terceiro" id="ds_avaliacao" placeholder="Informe sua justificativa. Em caso de concordância, Preencher com 'Concordo.'" class="wtext" rows="12">{{old('ds_terceiro')}}</textarea>
                                                </div>
                                            </div>
                                            <!-- form-group -->
                                            ...
                                            <div class="row" style="margin-top: 3%;">
                                                <div class="col-sm-9 col-sm-offset-3">
                                                    ...
                                                    <button type="submit"
                                                            class="btn btn-wide btn-primary btn-quirk mr5">Justificar</button>

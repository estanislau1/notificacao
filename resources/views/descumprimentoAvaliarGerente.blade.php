                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="panel">
                                    ...
                                    <form id='basicForm' name='basicForm' enctype="multipart/form-data" action='{{ url("descumprimento/incluiravaliacaogerencia")}}' method="post" class='form-horizontal'>
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">Avaliação <span
                                                    class="text-danger">*</span></label>
                                            <div class="col-sm-8">
                                                <select class="select2" id="bit_gerente" name="bit_gerente" style="width: 100%" data-placeholder="Informe sua decisão"  title="Campo avaliação obrigatório!! Favor preencher!" required>
                                                    <option disabled></option>
                                                    <option value="1">Favorável prosseguir com o descumprimento</option>
                                                    <option value="0">Solicitar retificação da minuta</option>
                                                    <option value="2">Cancelar por determinação da Gerência</option>
                                                </select>
                                            </div>
                                        </div>
                                        <!-- form-group -->
                                        ...
                                        <!-- form-group -->
                                        <div class="form-group" id="campo_avaliacao">
...
<script>
                                                    $(document).ready(function () {
                                                        ...
                                                        $("#msg_reaberta").hide();
                                                        $("#campo_avaliacao").hide();

                                                        //Configurando o campo de avaliação caso ele seja necessário. 
                                                        $("#bit_gerente").change(function () {

                                                            if ($("#bit_gerente").val() == 0 || $("#bit_gerente").val() == 2)
                                                            {
                                                                $("#campo_avaliacao").show();
